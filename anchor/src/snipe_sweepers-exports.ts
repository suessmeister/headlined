...
export const SNIPE_SWEEPERS_PROGRAM_ID = new PublicKey(SnipeSweepersIDL.address)

// This is a helper function to get the SnipeSweepers Anchor program.
export function getSnipeSweepersProgram(provider: AnchorProvider, address?: PublicKey) {
  return new Program({ ...SnipeSweepersIDL, address: address ? address.toBase58() : SnipeSweepersIDL.address } as SnipeSweepers, provider)
}
